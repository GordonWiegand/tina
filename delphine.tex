\chapter*{\centering {\FontH{\Huge Nina und die rosa Delphine}}\\\small \color{DeepPink} Oma Carola gewidmet}
...
\vspace{10pt}
\centerline{\Huge \Dolphin[DeepPink]\reflectbox{\Dolphin[DeepPink]}}
\vspace{10pt}
...
\afterpage{
    \begin{figure}
        \thispagestyle{empty}
        \centering
        \includegraphics[width=\textwidth]{bilder/delphin.pdf}       
    \end{figure}
    \clearpage
}

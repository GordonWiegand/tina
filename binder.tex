...
\chead{\color{HotPink}\hrulefill\hspace{0.2cm} \floweroneleft\floweroneright \hspace{0.2cm} \hrulefill}
%Kapitelüberschriften in Schriftart des Deckblatts
\addtokomafont{chapter}{\color{HotPink}\rmfamily\Huge\centering\itshape}
...
\input Typocaps.fd
\def\FontI{\color{HotPink}\fontsize{20pt}{0mm}\usefont{U}{Typocaps}{xl}{n}}
...
\begin{titlepage}
	\begin{center}
		...
		\FontH{\Huge \color{HotPink} Ein Buch für\\ Linda und Paula}\\ 
	\end{center}
		\vspace*{4\baselineskip}
	
	\begin{center}
		\begin{tabular}{p{7cm}p{5cm}}
			\textbf{\large \color{HotPink} Gordon Wiegand} & \textbf{\large \color{HotPink}  Linda Wiegand}\\
			\textbf{\large \color{HotPink}\itshape Texte} & \textbf{\large \color{HotPink}\itshape Illustrationen}\\
		\end{tabular}
